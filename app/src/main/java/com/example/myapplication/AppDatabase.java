...
import java.util.Map;
 ...
 //애플리케이션의 로컬 데이터 저장을 담당하는 Room 데이터베이스 클래스
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public static class Converters {
        ...
        //List 객체를 데이터베이스 저장을 위한 JSON 문자열로 변환
        @TypeConverter
        ...
        // Map 객체(날짜별 기록 데이터)를 데이터베이스 저장을 위한 JSON 문자열로 변환
        @TypeConverter
